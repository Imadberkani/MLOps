...
def train_and_evaluate(config_path):
    ...
    if model_choice == "DecisionTreeClassifier":
        criterion = config["DecisionTreeClassifier"]["criterion"]
        max_depth = config["DecisionTreeClassifier"]["max_depth"]
        run_name = config["mlflow_DecisionTreeClassifier_config"]["run_name"]
